...
import com.gamediscovery.GenreMicroService.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleResourceNotFoundException(GenreNotFoundException gameNotFoundException, WebRequest webRequest){
